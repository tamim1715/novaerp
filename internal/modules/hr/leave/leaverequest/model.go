...
const (
	StatusPending   = enums.StatusPending
	StatusApproved  = enums.StatusApproved
	StatusRejected  = enums.StatusRejected
	StatusCancelled = enums.StatusCancelled
)
...
type LeaveRequest struct {
	...
	Status      enums.Status `gorm:"size:20;default:'PENDING'" json:"status"` // PENDING, APPROVED, REJECTED
